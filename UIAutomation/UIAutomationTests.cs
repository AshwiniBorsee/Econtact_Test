...
namespace UIAutomation
{
    ...
    public class UIAutomationTests
    {
        ...
        public void Verify_UI_Add_Contact(String FirstName, String LastName, String ContactNo, String Address, String Gender)
        {
            ...
            {
                Assert.Fail($"Test Failed with message {ex.Message}");
            }
            finally
            {
        ...
        public void Verify_Data_grid()
        {
            ...
            try
            {
                ...
                var data_grid = window.FindFirstDescendant(cf => cf.ByAutomationId("dgvContactList"));
                var firstRowDescendants = data_grid.FindAllChildren();
                throw new NotImplementedException("Test is inconclusive because data grid element is dynamic");
            ...
            catch (Exception ex)
            {
                ...
                //TestContext.WriteLine("Integration test is inconclusive because ...");
                //TestContext.SetOutcome(UnitTestOutcome.Inconclusive);
            }
            finally
            {
                app.Close();
